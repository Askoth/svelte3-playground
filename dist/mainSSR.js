...
const css = {
	...
	map: "{\"version\":3,\"file\":\"bar.svelte\",\"sources\":[\"bar.svelte\"],\"sourcesContent\":[\"<div>this is bar {check}</div>\\n\\n<button class=\\\"button\\\" on:click={something}>click me!</button>\\n\\n<div>Clicked {num} times.</div>\\n\\n<dl>\\n  <dt>Derivative:</dt>\\n  <dd>{myDerivative}</dd>\\n</dl>\\n\\n<script>\\n\\n  console.log(\\\"We are now at bar\\\")\\n\\n  let check = \\\"not clicked\\\";\\n  let num = 0;\\n\\n  $: myDerivative = `${check} ${num}`;\\n\\n  function something() {\\n    check = \\\"clicked\\\";\\n    num++;\\n  }\\n</script>\\n\\n<style>\\n  .button {\\n    background-color: darkgreen;\\n    color: white;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AA2BE,sBAAQ,CACN,gBAAgB,CAAE,SAAS,CAC3B,KAAK,CAAE,KACT\"}"
};
...
<dl><dt>Derivative:</dt><dd>${internal.escape(myDerivative)}</dd></dl>`;
});
